...
# File name : levelViewer.php
# Task 		: Server side mgmt of levels.
# Coder 	: Raptor
...
if (array_key_exists("download",$_POST)) 
{
	...
	if (file_exists($filename)) 
	{
	 ...
	 $logger->addLog("Map $zip_name was downloaded.");
}
...
if (array_key_exists("delete",$_POST)) 
{
	...
	{
		$logger->addLog("Authorization Failed. Redirecting to login form.", 'e');
	...
	$logger->addLog("Level " . $map['name'] . " was deleted.");
	header("Refresh:0");
}
